...
declare class EmailsResource {
     ...
     */
    send(body: SendEmailV1Request, opts?: IdempotencyOptions): Promise<EmailV1>;
    /**
     ...
     */
    sendLegacy(body: SendEmailRequest, opts?: IdempotencyOptions): Promise<SendEmailData>;
    /**
     ...
     * was one.
     */
    sendTest(body: SendTestEmailV1Request): Promise<EmailTestV1>;
